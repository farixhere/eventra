  ...
  return <main className="studioPage">
    ...
    <div className="studioShell">
      ...
      <section className="studioContent">
        ...
        {section==="branding"&&<form className="studioForm" onSubmit={e=>{e.preventDefault();mutate("/api/events","PATCH",{id:eventId,...forms.branding})}}>
          <h2>Website & branding</h2><p>Control the public event page without touching code.</p>
          ...
          <label>Logo URL<input value={forms.branding.logo_url||""} onChange={e=>setForms(x=>({...x,branding:{...x.branding,logoUrl:e.target.value}}))}/></label>
          <label>Banner URL<input value={forms.branding.banner_url||""} onChange={e=>setForms(x=>({...x,branding:{...x.branding,bannerUrl:e.target.value}}))}/></label>
          <div className="studioTwo"><label>Primary color<input type="color" value={forms.branding.primary_color||"#d7ff3f"} onChange={e=>setForms(x=>({...x,branding:{...x.branding,primaryColor:e.target.value}}))}/></label><label>Secondary color<input type="color" value={forms.branding.secondary_color||"#111111"} onChange={e=>setForms(x=>({...x,branding:{...x.branding,secondaryColor:e.target.value}}))}/></label></div>
          <label><span>Public event</span><input type="checkbox" checked={Boolean(forms.branding.is_public)} onChange={e=>setForms(x=>({...x,branding:{...x.branding,isPublic:e.target.checked}}))}/></label>
          <label><span>Registration open</span><input type="checkbox" checked={Boolean(forms.branding.registration_open)} onChange={e=>setForms(x=>({...x,branding:{...x.branding,registrationOpen:e.target.checked}}))}/></label>
          <button disabled={saving}>Save website settings</button>
        </form>}
