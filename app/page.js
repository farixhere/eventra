    ...
    <main>
      ...
      <section className="hero">
        ...
        <div className="heroActions">
          <Link className="primary" href="/dashboard">Start organizing →</Link>
      ...
      <section className="features" id="features">
        ...
        <div className="featureGrid">{features.map(f => <article key={f.n}><small>{f.n}</small><h3>{f.title}</h3><p>{f.text}</p></article>)}</div>
      </section>
