...
export default async function EventPage({ params }) {
  ...
  const sections = { programmes:true, schedule:true, results:true, gallery:true, announcements:true, downloads:true, participants:true, contact:true, ...(event.website_sections || {}) };
  ...
  return <main className="publicEvent" style={theme}>
    <nav className="publicNav"><a href={"/event/"+event.slug}>EVENTRA<span>.</span></a><div>
      {sections.programmes && <a href="#programmes">Programmes</a>}{sections.schedule && <a href="#schedule">Schedule</a>}{sections.results && <a href="#results">Results</a>}{sections.gallery && <a href={"/event/"+event.slug+"/gallery"}>Gallery</a>}{sections.contact && <a href={"/event/"+event.slug+"/contact"}>Contact</a>}
    </div></nav>
